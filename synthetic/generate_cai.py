...
def main(args):
    ...
    with open(args.constitution_file) as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Column in the dataset containing the prompt/instruction.",
    )
    parser.add_argument(
        "--metadata_columns",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Path to the constitution file.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--enable_critique",
        action="store_true",
        help="Enable constitutional critique and revision loop.",
    )
    parser.add_argument(
        "--max_revisions",
        type=int,
        default=1,
        help="Maximum number of critique/revision iterations.",
    )
