"""Shared helpers for reading and writing `.metadata` files.

A `.metadata` file is a small text file of `key: value` lines:

   Samples: 20000
   Tokens: 8192000

When reading, numeric values are converted back to `int`/`float`; anything
else stays a `str`.
"""
