...
def build_reference_indices(
    reference_ids, min_k: int, max_k: int, approx_max_k: int, allow_one_token_mismatch: bool
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_proc", type=int, default=8, help="Number of processes for dataset operations."
    )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        "--output_dir", type=str, required=True, help="Output directory for cleaned shards."
    )
    parser.add_argument(
        "--output_type",
        type=str,
    ...
    parser.add_argument(
        "--min_k", type=int, default=8, help="Minimum token span considered a match."
    )
    parser.add_argument(
        "--max_k",
        type=int,
