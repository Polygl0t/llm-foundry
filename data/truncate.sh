...
out="$workdir/run_outputs/out-truncate.$SLURM_JOB_ID"
err="$workdir/run_outputs/err-truncate.$SLURM_JOB_ID"
...
#############################################
python3 "$workdir/truncate.py" \
    --input_dir "$workdir/portuguese/gigaverbo-v2-sft/reasoning" \
    --output_dir "$workdir/portuguese/gigaverbo-v2-sft/reasoning_4b_subset" \
