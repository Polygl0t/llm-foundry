...
def main(args):
    ...
    with open(lang_script_dict[LANGUAGE]) as f:
    ...
    quality_filters = LocalPipelineExecutor(
        pipeline=[
            ...
            # See https://github.com/huggingface/datatrove/blob/main/src/datatrove/pipeline/writers/jsonl.py
            JsonlWriter(
                FINAL_OUTPUT_FOLDER, compression=None, expand_metadata=args.expand_metadata
            ),
        ],
        tasks=TASKS,
        workers=WORKERS,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="./.configs",
        help="Folder containing language configuration files",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--final_output_folder", type=str, default="./final_output", help="Final output folder"
    )
    parser.add_argument(
