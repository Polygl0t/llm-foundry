"""
Shared logic from unicode filter and langdetect filter.

Includes functions called in unicode filter and langdetect filter with the purpose of resuable dataset loading, saving, and text-handling functions.
"""
import glob
import os
import numpy as np
