"""
Training Argument Specifications for FSDP Model Training

This module defines the TrainingArguments dataclass that contains all configuration
parameters for distributed language model training with PyTorch FSDP.
"""
